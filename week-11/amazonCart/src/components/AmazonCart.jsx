...
import { datastore } from "./data";
 function AmazonsCart() {
    ...
    return<RecoilRoot><div className="  flex "><Purchase/>
...
export function Purchase() {
    ...
    </div><div className=" bg-white rounded-md h-100 w-100 absolute top-40 right-2/6 z-10 ">
          <div className="p-8"> <div className="font-bold text-2xl">Purchase Sucessful</div>
          <div>Thank you for your purchase. Your order has been sucessfully processed</div>
          <div>Total Amount: ₹ {Math.ceil(total.totalprice)} </div>
          </div> 
            </div></div>
